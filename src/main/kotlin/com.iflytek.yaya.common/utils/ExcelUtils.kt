...
import com.iflytek.yaya.common.annotation.ExcelFieldName
import com.iflytek.yaya.common.annotation.ReflectHelper
...
object ExcelUtils {
    ...
    private fun getObjectExcelFieldNameMap(cls: Class<*>): Map<String, String> {
        ...
        for ((key, value) in fieldMap) {
            ...
            val apiModelProperty = value.getAnnotation(ApiModelProperty::class.java)
            if (apiModelProperty != null) {
                ret.put(apiModelProperty.value, key)
            }
        }
        return ret
    }
    ...
    private fun getObjectExcelFieldMap(cls: Class<*>): Map<String, Field> {
        ...
        for ((_, value) in fieldMap) {
            ...
            val apiModelProperty = value.getAnnotation(ApiModelProperty::class.java)
            if (apiModelProperty != null) {
                ret.put(apiModelProperty.value, value)
            }
        }
        return ret
    }
